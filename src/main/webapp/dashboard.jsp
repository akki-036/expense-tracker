...
Double monthlyTotal =
    (request.getAttribute("monthlyTotal") != null)
    ? (Double) request.getAttribute("monthlyTotal")
    : 0.0;
...
Integer count =
    (request.getAttribute("count") != null)
    ? (Integer) request.getAttribute("count")
    : 0;

List expenses =
    (List) request.getAttribute("expenses");

/* MONTHLY CHART */

Map<Integer, Double> monthMap =
...
<div class="main">
    ...
    <div class="transactions">
        ...
        if(expenses != null && !expenses.isEmpty()){
            int limit =
                Math.min(7, expenses.size());
            for(int i = 0; i < limit; i++){
                Map<String,Object> e =
                    (Map<String,Object>) expenses.get(i);
        %>
